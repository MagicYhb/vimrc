...
if [ x"$CS_MODE" == x"-b" ]; then
    ...
    if [ x"$#" == x"2" ]; then
        ...
        find "$INPUT_PATH" -name "*.c"  -o -name "*.h" -o -name "*.cpp" -o -name "*.cc" -o -name "*.java" -o -name "*.mk" -o -name "Makefile"  > cscope/"$CSCOPE_FILE".files
        ...
        do
            ...
            if [ x"1" == x"$MATCHED" ]; then
                ...
                find "$INPUT_PATH/$sfile" -name "*.c"  -o -name "*.h" -o -name "*.cpp" -o -name "*.cc" -o -name "*.java" -o -name "*.mk" -o -name "Makefile" >> cscope/"$CSCOPE_FILE".files
            fi
        done
    ...
    if [ x"$#" == x"1" ]; then
        ...
        if [ "$FILE_COUNT" == "0" ]; then
            ...
            do
                ...
                find "$REBUILD_PATH" -name "*.c"  -o -name "*.h" -o -name "*.cpp" -o -name "*.cc" -o -name "*.java" -o -name "*.mk" -o -name "Makefile" > $refiles
